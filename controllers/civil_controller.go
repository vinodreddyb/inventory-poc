...
func GetContractScheduleProgress(c *fiber.Ctx) error {

	progress := services.GetContractProgress()
...
func GetContractScheduleProgressPieChart(c *fiber.Ctx) error {

	progress := services.GetContractProgressPieChart()
